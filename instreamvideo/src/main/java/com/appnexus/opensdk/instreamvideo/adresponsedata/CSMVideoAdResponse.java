...
public class CSMVideoAdResponse extends BaseAdResponse {
    ...
    public CSMVideoAdResponse(int width, int height, String adType, String notifyUrl, ArrayList<String> impressionURLs) {
    ...
    public String getCSMVideoAdResponse() {
