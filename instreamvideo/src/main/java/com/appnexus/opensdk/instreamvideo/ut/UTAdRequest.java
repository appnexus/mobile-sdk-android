...
import com.appnexus.opensdk.instreamvideo.UTAdRequester;
...
public class UTAdRequest extends AsyncTask<Void, Integer, UTAdResponse> {
    ...
    public static final String TAG_ASSET_URL="require_asset_url";
    public static final boolean TAG_ASSET_URL_VALUE = false;
    ...
    protected UTAdResponse doInBackground(Void... params) {
        ...
        if (requester != null) {
            try {
                String baseUrl = Settings.getRequestBaseUrlUTV2();
