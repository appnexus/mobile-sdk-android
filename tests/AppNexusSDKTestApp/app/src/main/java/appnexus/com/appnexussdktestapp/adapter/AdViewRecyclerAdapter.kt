        ...
        if (currentAd is NativeAdResponse) {
            ...
            if (currentAd is InterstitialAdView) {
                ...
                if (currentAd is BannerAdView) {
                    if (currentAd.isLazyLoadEnabled && currentAd.isLazyLoadInactive && currentAd.getTag(
                            R.string.button_tag
                        ) == null
                    ) {
                        ...
                        btn.setOnClickListener {
                            ...
                            currentAd.loadWebview()
                        }
                        currentAd.setTag(R.string.button_tag, btn)
                        holder.layoutMain.addView(btn)
                    } else {
                        if (currentAd.getTag(R.string.button_tag) is Button && currentAd.isLazyLoadEnabled && !currentAd.isLazyLoadInactive) {
