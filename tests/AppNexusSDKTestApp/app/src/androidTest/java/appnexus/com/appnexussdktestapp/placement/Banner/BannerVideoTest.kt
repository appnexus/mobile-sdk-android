...
class BannerVideoTest {
    ...
    * */
    ...
    fun bannerVideoLoadTest() {
        ...
        bannerActivity.triggerAdLoad("14757590", allowVideoDemand = true, creativeId = 138061604)
    ...
    * */
    ...
    fun bannerVPAIDVideoLoadTest() {
        ...
        bannerActivity.triggerAdLoad("14768519", allowVideoDemand = true, creativeId = 138587669)
