...
package appnexus.com.trackertestapp.viewability.banner_video
...
class BannerVideoViewabilityTrackerTests {
    val Int.dp: Int
...
//    /*
//    testBannerVideoOMIDEventSupportedIsYes: To test the OMID is supported tracker is fired by the Banner Ad.
//    */
//    @Test
//    fun testBannerVideoOMIDEventSupportedIsYes() {
...
//
//    /*
//     testBannerVideoOMIDEventSessionStart: To test the OMID is Session Start & few related events are fired by the Banner Ad.
//     */
//    @Test
//    fun testBannerVideoOMIDEventSessionStart() {
////        setupAndLoadBannerVideo()
////        Thread.sleep(20000)
////        println("DISPATCH: LIST: " + mockDispatcher.arrRequests)
////        for (request in mockDispatcher.arrRequests) {
...
//
    /*
     testBannerVideoOMIDEventPercentageViewableZero: To test the OMID is 0% Viewable
     */
    @Test
    fun testBannerVideoOMIDEventPercentageViewableZero() {
        setupAndLoadBannerVideo()
        Thread.sleep(TestResponsesUT.DELAY)
        println("DISPATCH: LIST: " + mockDispatcher.arrRequests)
    ...
    /*
     testBannerVideoOMIDEventViewable100Percentage: To test the OMID is 100% Viewable
     */
    @Test
    fun testBannerVideoOMIDEventPercentageViewable100() {
        setupAndLoadBannerVideo()
        Thread.sleep(TestResponsesUT.DELAY)
        println("DISPATCH: LIST: " + mockDispatcher.arrRequests)
    ...
    /*
     testBannerVideoOMIDVersionEvent: To verify the OMID Start event
     */
    @Test
    fun testBannerVideoOMIDEventStart() {
        setupAndLoadBannerVideo()
        Thread.sleep(TestResponsesUT.DELAY)
        println("DISPATCH: LIST: " + mockDispatcher.arrRequests)

        for (request in mockDispatcher.arrRequests) {
            if (request.contains("\"type\":\"start\"")) {
                versionEvent = true
                break
            }
        }
...
//    /*
//     testBannerVideoOMIDTypeImpression: To test the OMID Media Type and impressionType
//     */
//    @Test
//    fun testBannerVideoOMIDTypeImpression() {
////        setupAndLoadBannerVideo()
////        Thread.sleep(TestResponsesUT.DELAY)
////        println("DISPATCH: LIST: " + mockDispatcher.arrRequests)
////
...
//    }
    ...
    /*
     testBannerVideoOMIDSessionFinish: To verify Session finish getting fired
     */
    @Test
    fun testBannerVideoOMIDSessionFinish() {
        setupAndLoadBannerVideo()
        Thread.sleep(TestResponsesUT.DELAY)
        runOnUiThread {
            bannerActivity.removeBannerAd()
