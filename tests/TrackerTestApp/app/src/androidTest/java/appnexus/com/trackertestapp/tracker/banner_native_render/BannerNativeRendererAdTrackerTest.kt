...
package appnexus.com.trackertestapp.tracker.banner_native_render
...
class BannerNativeRendererAdTrackerTest {
    val Int.dp: Int
    ...
    fun setup() {
        ...
        mockDispatcher.adType = "BannerNativeRenderAd"
     ...
     */
    @Test
    fun testBannerNativeRendererImpressionTrackerTestAd() {
        bannerActivity.triggerAdLoad("20331545", allowNativeDemand = true, useNativeRenderer = true, rendererId = 0)
     ...
     */
    @Test
    fun testBannerNativeRendererClickTrackerTestAd() {
        bannerActivity.triggerAdLoad("20331545", allowNativeDemand = true, useNativeRenderer = true, rendererId = 0)
        Espresso.onView(ViewMatchers.withId(R.id.linearLayout))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
        Espresso.onView(ViewMatchers.withId(R.id.linearLayout))
