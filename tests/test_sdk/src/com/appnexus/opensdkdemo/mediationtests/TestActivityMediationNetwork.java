...
public class TestActivityMediationNetwork extends ActivityInstrumentationTestCase2<DemoMainActivity> implements AdRequester {
...
//		ThirdSuccessfulMediationView.didPass = false;
	...
	public void testMMNetworkInterruption() {
		...
		shouldWork = new AdRequest(this, null, null, null, MMId, null, null, 320, 50, -1, -1, null, null, null, true, null, false, false);
		shouldWork.execute();
		pause();
		shouldWork.cancel(true);
